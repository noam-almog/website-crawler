import {log, LogLevel, PlaywrightCrawler, Sitemap} from 'crawlee';
...
console.log(`\n\t Depth: ${program.opts().depth} \n\t Output File: ${program.opts().outputFile} \n\t Limit Requests: ${program.opts().limitRequests}\n`)
